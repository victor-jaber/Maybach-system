  ...
  const createMutation = useMutation({
    mutationFn: async (data: SaleFormValues) => {
      ...
      const salePayload = {
        ...
        downPayment: downPaymentNum !== null ? String(downPaymentNum) : null,
        financedValue: financedValueNum !== null ? String(financedValueNum) : null,
        installments: data.installments || null,
        installmentValue: installmentValueNum !== null ? String(installmentValueNum) : null,
